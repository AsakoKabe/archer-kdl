...
import { configureDefaultCommands, GlspSocketServerLauncher, GlspVscodeConnector, SocketGlspVscodeServer } from '@eclipse-glsp/vscode-integration';
...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
    ...
    const minimalServer = new SocketGlspVscodeServer({
        clientId: 'glsp.kdl',
        clientName: 'kdl',
        connectionOptions: { port: serverProcess?.getPort() || JSON.parse(process.env.KDL_GLSP_SERVER_PORT || DEFAULT_GLSP_SERVER_PORT) }
    });
