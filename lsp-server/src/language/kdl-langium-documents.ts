...
import { KDLRoot } from './generated/ast.js';
import { isPackageUri } from './kdl-package-manager.js';
import { fixDocument } from './util/ast-util.js';
import { Utils } from './util/uri-util.js';

export class KDLLangiumDocuments extends DefaultLangiumDocuments {
    ...
    createEmptyDocument(uri: URI, rootType = KDLRoot): LangiumDocument {
