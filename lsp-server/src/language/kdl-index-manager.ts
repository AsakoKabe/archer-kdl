...
export class KDLIndexManager extends DefaultIndexManager {
    constructor(protected services: KDLSharedServices) {
        super(services);
    }
    ...
    resolveElement(description?: AstNodeDescription): AstNode | undefined {
        ...
        return document
            ? this.serviceRegistry
                  ...
                  .workspace.AstNodeLocator.getAstNode(document.parseResult.value, description.path)
            : undefined;
    }
