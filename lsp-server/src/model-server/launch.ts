 ...
 ********************************************************************************/
import { MODELSERVER_PORT_COMMAND } from '@kdl/protocol';
import console from 'console';
import * as net from 'net';
import * as rpc from 'vscode-jsonrpc/node.js';
import { URI } from 'vscode-uri';
import { KDLLSPServices } from '../language/integration.js';
 ...
 */
async function createClientConnection(socket: net.Socket, services: KDLLSPServices): Promise<void> {
