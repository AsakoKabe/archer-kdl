...
import { KDLTerminals } from '../generated/ast.js';

export class KDLTokenBuilder extends IndentationAwareTokenBuilder {
    protected readonly listItemRegExp = new RegExp(KDLTerminals.LIST_ITEM.source, KDLTerminals.LIST_ITEM.flags + 'y');
