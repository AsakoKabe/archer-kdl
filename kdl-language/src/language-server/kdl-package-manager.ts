...
import { SystemInfo, SystemUpdatedEvent, SystemUpdateListener } from '@kdl/protocol';
import { Disposable, DocumentState, LangiumDocument, MultiMap } from 'langium';
import { PackageJson } from 'type-fest';
import { CancellationToken, WorkspaceFolder } from 'vscode-languageserver';
import { URI, Utils as UriUtils } from 'vscode-uri';
import { KDLSharedServices } from './kdl-module.js';
import { QUALIFIED_ID_SEPARATOR } from './kdl-naming.js';
import { PackageAstNodeDescription } from './kdl-scope.js';
 ...
 */
export class KDLPackageManager {
