...
import { GlobalAstNodeDescription, isGlobalDescriptionForLocalPackage, PackageAstNodeDescription } from './kdl-scope.js';
...
export class PackageScopeProvider extends DefaultScopeProvider {
    constructor(
        protected services: KDLServices,
...
export class KDLScopeProvider extends PackageScopeProvider {
