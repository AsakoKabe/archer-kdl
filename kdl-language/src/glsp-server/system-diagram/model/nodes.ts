...
import { ENTITY_NODE_TYPE, LABEL_ENTITY, REFERENCE_CONTAINER_TYPE, REFERENCE_PROPERTY, REFERENCE_VALUE } from '@kdl/protocol';
...
export class GEntityNodeBuilder extends GNodeBuilder<GEntityNode> {
    set(node: EntityNode, index: KDLModelIndex): this {
